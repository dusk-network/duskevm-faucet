...
FLASK_APP=api FAUCET_DATABASE_URI=sqlite:///$(pwd)/test.db python3 -m flask create_enabled_token DUSK 745 0x0000000000000000000000000000000000000000 0.0001 native
